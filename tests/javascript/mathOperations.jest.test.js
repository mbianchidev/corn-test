...
describe('MathOperations (Jest)', () => {
  ...
  describe('power', () => {
    test('should correctly calculate exponentials', () => {
  ...
  describe('pi', () => {
    test('should return the first 40 decimals of pi', () => {
      expect(mathOps.pi()).toBe('3.1415926535897932384626433832795028841971');
    });
  });

  describe('gcd', () => {
    test('should correctly calculate greatest common divisor', () => {
  ...
  describe('derivative', () => {
    test('should return correct derivative coefficients', () => {
    ...
    test('should return zero for empty polynomial', () => {
      expect(mathOps.derivative([])).toEqual([0]);
    });

    test('should throw for null coefficients', () => {
      expect(() => mathOps.derivative(null)).toThrow('Coefficients array must not be null');
    });
  });
});
